    ...
    if apply_preset:
        ...
        if preset_state is not None:
            ...
            corpus_setting_keys = {
                ...
                "aoa_exclude_proper": (
                    f"corpus_aoa_exclude_proper_{project_id}"
                ),
                "aoa_content_words_only": (
                    f"corpus_aoa_content_only_{project_id}"
                ),
                ...
                "meter_interpretation_depth": (
                    f"corpus_meter_depth_{project_id}"
                ),
                "meter_line_match_threshold": (
                    f"corpus_meter_line_threshold_{project_id}"
                ),
                "meter_irregular_threshold": (
                    f"corpus_meter_poem_threshold_{project_id}"
                ),
                "meter_ambiguity_margin": (
                    f"corpus_meter_margin_{project_id}"
                ),
                "meter_maximum_variants": (
                    f"corpus_meter_variants_{project_id}"
                ),
                ...
                "meter_allow_visible_elision": (
                    f"corpus_meter_elision_{project_id}"
                ),
            }
