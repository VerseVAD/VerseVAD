"""Stable UTF-8 CSV and narrative Word lexical-style exports."""
...
def export_lexical_style_bundle(
    ...
    *,
    ...
    bundle = {
        ...
        "lexical_style_manifest.csv": export_module_manifest_csv(result),
    }
    bundle["lexical_style_report.docx"] = (
        build_narrative_report_from_summary_csv(
            "lexical_style",
            bundle["lexical_style_summary.csv"],
