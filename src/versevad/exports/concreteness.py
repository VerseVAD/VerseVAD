"""Stable UTF-8 CSV and narrative Word exports for concreteness results."""
...
def export_concreteness_bundle(
    ...
    *,
    ...
    bundle = {
        ...
        "concreteness_manifest.csv": export_module_manifest_csv(result),
    }
    bundle["concreteness_report.docx"] = (
        build_narrative_report_from_summary_csv(
            "concreteness",
            bundle["concreteness_summary.csv"],
